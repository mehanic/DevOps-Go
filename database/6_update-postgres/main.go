...
func booksCreateProcess(w http.ResponseWriter, r *http.Request) {
	...
	// insert values
	_, err = db.Exec("INSERT INTO books_variant (isbn, title, author, price) VALUES ($1, $2, $3, $4)", bk.Isbn, bk.Title, bk.Author, bk.Price)
	if err != nil {
		http.Error(w, http.StatusText(500), http.StatusInternalServerError)
		return
	}
...
func booksUpdateProcess(w http.ResponseWriter, r *http.Request) {
	...
	// insert values
	_, err = db.Exec("UPDATE books_variant SET isbn = $1, title=$2, author=$3, price=$4 WHERE isbn=$1;", bk.Isbn, bk.Title, bk.Author, bk.Price)
	if err != nil {
		http.Error(w, http.StatusText(500), http.StatusInternalServerError)
		return
	}
...
// 978-1505255607 - The Time Machine - H. G. Wells - 5.99 - update

// 978-1503379640 - The Prince - Niccolò Machiavelli - 6.99 - update

// 978-1503261969 - Emma - Jayne Austen - 9.44 - update

// 978-1470184841 - Metamorphosis - Franz Kafka - 7.8 - update
