...
// Byte breakdown
// Bytes	Meaning	Value
// 128 36 17 0	                                 ID (4 bytes)	1123456
// 9 0 0 0	                                     String length (4 bytes)	9
// 118 46 114 111 109 97 110 111 118	         Login (9 bytes)	"v.romanov"
// 16 0 0 0	                                     Flags (4 bytes)	16
...
// &main.User{ID:1123456, RealName:"", Login:"v.romanov", Flags:16}⏎
